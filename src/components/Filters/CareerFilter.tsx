...
const CareerFilter = () => {
  ...
  return (
    <div className='flex justify-center'>
      ...
      <div className="relative w-full max-w-[350px] lg:max-w-[500px] h-[50px] mx-[20px] lg:mx-[40px] mt-[12px] mb-[8px] gap-[8px] border-t border-t-[0.8px] border-transparent inline-flex justify-center text-sm bg-white">
...
//             <button
//               key={item.career_type}
//               className={`box-border px-[8px] lg:px-[12px] w-[82px] lg:w-[100px] h-[38px] mx-[0.8px] items-center leading-none whitespace-pre-line ${activeItems.includes(item.career_type)
//                   ? 'bg-pr-100 text-white' // 활성화된 상태일 때
//                   : 'bg-white text-neut-45' // 비활성화된 상태일 때
//                 }`}
//               style={{
