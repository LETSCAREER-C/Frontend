...
const CareerTags: React.FC<CareerTagProps> = ({ status }) => {
  ...
  return (
    <div className={`w-[55.67px] h-[24px] px-2.5 py-1 rounded-lg flex justify-center items-center gap-1 ${tagStyles}`}>
      {statusIcon && <div className="flex items-center justify-center w-[11px] h-[11px]">{statusIcon}</div>} {/* 아이콘 렌더링 */}
