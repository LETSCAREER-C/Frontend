...
const ProgramBox: React.FC<ProgramBoxProps> = ({ program }) => {
  ...
  return (
    <div
      key={program.id}
      className='relative flex flex-col justify-center rounded-lg border border-gray-300 mb-[20px] mr-[20px] w-[165px] h-[306px] p-[8px] sm:w-[275px] sm:h-[321px] sm:p-[10px]'
