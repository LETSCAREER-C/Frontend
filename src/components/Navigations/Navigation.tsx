...
const Navigation: React.FC = () => {
  ...
  return (
    <>
      <nav className="h-[60px] fixed top-0 left-0 w-full bg-white border-b-[1px] z-50 flex justify-between px-5 py-3 mx-auto md:h-[70px] md:px-12 md:py-3 md:mx-auto">
